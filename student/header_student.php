...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block"> <a href="main.php" class="nav-link">Home</a> </li>
...
<img src="../sources/um_logo_only.png" alt="UM~ Logo" class="brand-image " style="opacity: 8"><span class="brand-text font-weight-light">E-Attendance@UM</span>
  ...
  <div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image"> <img src="student_profile/<?php echo $profile_pic; ?>" class="img-circle elevation-2" alt="User Image"> </div>
