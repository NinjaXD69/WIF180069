...
<?php include 'header_lecturer.php'; ?>
  ...
  <section class="content-header" >
    <div class="container-fluid">
      <div class="row mb-0">
        <div class="col-sm-6">
          <h5 style="font-family:Helvetica; font-weight:bold;">ATTENDANCE ANALYSIS</h5>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="card">
      ...
      <table class="table table-striped projects">
        ...
        ?></td>
        <td class="project-actions text-center"><a class="btn btn-primary btn-sm" href="analysis_view.php?course_id=<?php echo $course_id; ?>"> <i class="fas fa-folder"> </i> View </a></td>
        </tr>
        <?php
        }} 
		else {
